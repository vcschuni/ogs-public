...
GRANT CONNECT ON DATABASE $POSTGRESQL_AUTH_DB TO $POSTGRESQL_AUTH_USER;
GRANT USAGE ON SCHEMA public TO $POSTGRESQL_AUTH_USER;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA public TO $POSTGRESQL_AUTH_USER;

ALTER DEFAULT PRIVILEGES IN SCHEMA public
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLES TO $POSTGRESQL_AUTH_USER;
EOSQL
